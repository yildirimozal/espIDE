...
const ESP32_38 = {
  ...
  left: [
    P(null, '3V3', 'power'),
    P(null, 'EN', 'en', ['RESET']),
    P(36, 'GPIO36', 'inputonly', ['ADC1_0', 'sadece giris']),
    P(39, 'GPIO39', 'inputonly', ['ADC1_3', 'sadece giris']),
    P(34, 'GPIO34', 'inputonly', ['ADC1_6', 'sadece giris']),
    P(35, 'GPIO35', 'inputonly', ['ADC1_7', 'sadece giris']),
    ...
    P(9, 'GPIO9', 'flash', ['flash — kullanma']),
    P(10, 'GPIO10', 'flash', ['flash — kullanma']),
    P(11, 'GPIO11', 'flash', ['flash — kullanma']),
    P(null, '5V / VIN', 'power'),
  ],
  right: [
    P(null, 'GND', 'gnd'),
    ...
    P(1, 'GPIO1', 'io', ['UART0_TX', 'konsol']),
    P(3, 'GPIO3', 'io', ['UART0_RX', 'konsol']),
    ...
    P(2, 'GPIO2', 'io', ['dahili LED', 'ADC2_2', 'Touch2']),
    P(15, 'GPIO15', 'io', ['ADC2_3', 'Touch3', 'strapping']),
    P(8, 'GPIO8', 'flash', ['flash — kullanma']),
    P(7, 'GPIO7', 'flash', ['flash — kullanma']),
    P(6, 'GPIO6', 'flash', ['flash — kullanma']),
  ],
};
...
const ESP32_30 = {
  ...
  right: [
    ...
    P(4, 'GPIO4', 'io', ['Touch0']),
    P(0, 'GPIO0', 'io', ['BOOT', 'strapping']),
    P(2, 'GPIO2', 'io', ['dahili LED', 'Touch2']),
    P(null, '3V3', 'power'),
  ],
};
...
const ESP32_C3 = {
  ...
  left: [
    ...
    P(6, 'GPIO6', 'io', []),
    P(7, 'GPIO7', 'io', []),
    P(8, 'GPIO8', 'io', ['dahili LED', 'strapping']),
