...
const DICT = {
  tr: {
    ...
    fs_skipped_dot: '({n} gizli dosya/klasör — “.” ile başlayan — atlandı)\n',
    ...
    tab_wireless: 'Telsiz', w_scan: 'Tara', w_auto: 'otomatik',
  ...
  en: {
    ...
    fs_skipped_dot: '({n} hidden file(s)/folder(s) — starting with “.” — skipped)\n',
    ...
    tab_wireless: 'Wireless', w_scan: 'Scan', w_auto: 'auto',
